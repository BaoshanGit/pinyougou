...
app.service('typeTemplateService',function($http){
	...
	//新建模板数据查询
	this.findBrandAndOption = function () {
		return $http.post("../typeTemplate/findBrandAndOption.do");
    }

    //根据模板ID查询规格数据
	this.specList = function (id) {
		return  $http.post('../typeTemplate/specList.do?id='+id);
    }
});
