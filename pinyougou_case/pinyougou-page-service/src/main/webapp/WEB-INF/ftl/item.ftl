                            ...
                            <#list specificationItemsList as spec>
                                <dl>
                                    <dt>
                                        ...
                                        <#list spec.attributeValue as spec_value>
                                                <dd><a href="javascript:;" class="{{specItems['${spec.attributeName}'] == '${spec_value}' ? 'selected':''}}"
                                                       ng-click="addSpecItem('${spec.attributeName}','${spec_value}')">${spec_value}<span title="点击取消选择">&nbsp;</span></a></dd>
                                        </#list>
                                </dl>
                            </#list>
						</div>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="{{shopNum}}" minnum="1" class="itxt" />
										<a href="javascript:void(0)" class="increment plus" ng-click="addShopNum(1)">+</a>
										<a href="javascript:void(0)" class="increment mins" ng-click="addShopNum(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
                                    <#list customAttributeItemsList as pojo>
                                        <#if pojo.value ??>
									        <li>${pojo.text}:${pojo.value}</li>
                                        </#if>
                                    </#list>
									<#--<li>后置摄像头：1200万像素</li>
									<li>前置摄像头：500万像素</li>
